...
LOAD DATA LOCAL INFILE 'db_project/finance-weather-db/date-relation.txt' INTO TABLE DATES
...
LOAD DATA LOCAL INFILE 'db_project/finance-weather-db/sector-relation.txt' INTO TABLE SECTOR
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';

LOAD DATA LOCAL INFILE 'db_project/finance-weather-db/security-relation.txt' INTO TABLE SECURITIES
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';

LOAD DATA LOCAL INFILE 'db_project/finance-weather-db/trade-relation.txt' INTO TABLE TRADES
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';
